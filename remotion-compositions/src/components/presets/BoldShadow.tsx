...
interface BoldShadowProps {
  wordSegments: WordSegment[]
  customization: SubtitleCustomization
}

export function BoldShadow({ wordSegments, customization }: BoldShadowProps) {
    ...
    >
      <span
        style={{
          ...
          color: customization.highlightColor,
          textShadow: '3px 3px 6px rgba(0,0,0,0.9), -1px -1px 0 rgba(0,0,0,0.6)',
        }}
      >
        {seg.punctuated_word}
      </span>
